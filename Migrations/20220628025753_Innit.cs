        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotherboardDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Screen = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScreenDetial = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StorageDrive = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StorageDriveDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ComputerSpec_SpecID",
                        column: x => x.SpecID,
                        principalTable: "ComputerSpec",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
